...
//+kubebuilder:webhook:path=/validate-image-ai-playground-io-v1alpha1-image,mutating=false,failurePolicy=fail,sideEffects=None,groups=image.ai-playground.io,resources=images,verbs=create;update,versions=v1alpha1,name=vimage.kb.io,admissionReviewVersions=v1
