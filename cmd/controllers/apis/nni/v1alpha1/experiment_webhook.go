...
//+kubebuilder:webhook:path=/validate-nni-ai-playground-io-v1alpha1-experiment,mutating=false,failurePolicy=fail,sideEffects=None,groups=nni.ai-playground.io,resources=experiments,verbs=create;update,versions=v1alpha1,name=vexperiment.kb.io,admissionReviewVersions=v1
