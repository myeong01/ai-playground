...
var resourcelog = logf.Log.WithName("resource-resource")
...
//+kubebuilder:webhook:path=/validate-resource-ai-playground-io-v1alpha1-resource,mutating=false,failurePolicy=fail,sideEffects=None,groups=resource.ai-playground.io,resources=resources,verbs=create;update,versions=v1alpha1,name=vresource.kb.io,admissionReviewVersions=v1
