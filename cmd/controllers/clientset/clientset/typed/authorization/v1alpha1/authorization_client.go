...
import (
	...
	v1alpha1 "github.com/myeong01/ai-playground/cmd/controllers/apis/authorization/v1alpha1"
...
// AuthorizationV1alpha1Client is used to interact with features provided by the authorization group.
type AuthorizationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AuthorizationV1alpha1Client) ClusterRoles() ClusterRoleInterface {
	return newClusterRoles(c)
}

func (c *AuthorizationV1alpha1Client) Groups(namespace string) GroupInterface {
