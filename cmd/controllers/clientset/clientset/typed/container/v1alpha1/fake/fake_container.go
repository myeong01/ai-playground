...
var containersResource = v1alpha1.SchemeGroupVersion.WithResource("containers")

var containersKind = v1alpha1.SchemeGroupVersion.WithKind("Container")
...
func (c *FakeContainers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(containersResource, c.ns, name, opts), &v1alpha1.Container{})
