...
var resourcesResource = v1alpha1.SchemeGroupVersion.WithResource("resources")

var resourcesKind = v1alpha1.SchemeGroupVersion.WithKind("Resource")
...
func (c *FakeResources) UpdateStatus(ctx context.Context, resource *v1alpha1.Resource, opts v1.UpdateOptions) (*v1alpha1.Resource, error) {
	obj, err := c.Fake.
...
func (c *FakeResources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(resourcesResource, c.ns, name, opts), &v1alpha1.Resource{})
